        ...
        <section className="h-1/2">
            <div className="w-full h-full flex items-center justify-center pt-10 max-[800px]:flex-col"> {/* container */}
                ...
                <div className="w-1/2 h-full flex flex-col items-start justify-start pt-10 pb-6 max-[800px]:items-center">
                    ...
                    <p className="font-semibold max-w-lg mb-10 pr-6 max-[1100px]:text-sm max-[1000px]:text-xs max-[800px]:text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid animi commodi eligendi eveniet ex facilis nemo nulla numquam odit sint. Atque eaque earum in ipsum magni nesciunt nisi pariatur quis saepe, voluptas? Aspernatur blanditiis consectetur earum, facere fugiat illum incidunt maxime minima nihil numquam omnis quibusdam recusandae rem. Incidunt, nesciunt.</p>
                    <span className="text-2xl font-bold text-gray-300 pt-2 pb-2 pl-6 pr-6 bg-green-800 rounded-3xl cursor-pointer hover:bg-gradient-to-t from-green-900 to-green-900 transition-all duration-500 ease-in-out flex justify-center items-center max-[1000px]:text-sm">Log in</span>
                </div>
            </div>
        </section>
    )
